...
static void UpdateScoreDisplay(void)
{
    ...
    LCD_PutString(167, 120, (uint8_t *)text, 0x01AF, 0x963F);
}
...
static void UpdateLevelDisplay(void)
{
    ...
    LCD_PutString(167, 195, (uint8_t *)text, 0x01AF, 0x963F);
}
...
static void UpdateTimerDisplay(void)
{
    ...
    LCD_PutString(167, 155, (uint8_t *)text, 0x01AF, 0x963F);
}
...
static void TogglePause(GameSession *session)
{
    ...
    ClearHudField(167, 235, 56);
    if (session->isPaused) {
        LCD_PutString(167, 235, (uint8_t *)"PAUSED", 0xF800, 0x963F);
    } else {
        LCD_PutString(167, 235, (uint8_t *)"PAUSE ", 0x01AF, 0x963F);
    }
}
...
void GameSession_WaitForStart(void)
{
    ...
    (*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((0)<<2)))) = 0;
    g_buttons.prev_PA0 = (*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((0)<<2))));
    TimerDelay_Start(0);
